...
func LocalThink() {
	for _, player := range local.players {
		...
		down_axis = gin.In().GetKeyFlat(gin.Down, gin.DeviceTypeKeyboard, gin.DeviceIndexAny)
		up_axis = gin.In().GetKeyFlat(gin.Up, gin.DeviceTypeKeyboard, gin.DeviceIndexAny)
		right_axis = gin.In().GetKeyFlat(gin.Right, gin.DeviceTypeKeyboard, gin.DeviceIndexAny)
		left_axis = gin.In().GetKeyFlat(gin.Left, gin.DeviceTypeKeyboard, gin.DeviceIndexAny)
